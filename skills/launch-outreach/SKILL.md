...
description: |
  Build a product launch's supporter audience and draft paste-ready, platform-compliant outreach to team,
  friends, users, waitlists, communities, and public followers. Produces teaser DMs, launch emails,
  community notices, personal messages, social amplification posts, and permitted wave schedules under
  `.ulpi/launch/CHANNEL/OUTREACH.md`. Grounds every message in the real product, never solicits or
  incentivizes votes, and never mass-spams. Use standalone when a launch needs an audience and messages, or
  from the Product Hunt, Hacker News, X, and LinkedIn runners under their specific compliance modes.
allowed-tools:
  - AskUserQuestion
  - Read
  - Write

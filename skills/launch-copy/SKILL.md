...
name: launch-copy
description: |
  Draft grounded product-launch copy in distinct feature-led, benefit-led, comparison, and audience-led
  angles, with one recommended version for each requested asset. Produces taglines, headlines, one-liners,
  descriptions, launch posts, and first comments while obeying exact character limits, voice, and platform
  compliance rules. Reuses `.ulpi/launch/positioning.md` or grounds the product from its site and repository.
  Use standalone for launch copy or as the shared copy workflow for Product Hunt, Hacker News, X, and
  LinkedIn runners. Do not use for long-form content, visual design, or person-to-person outreach.
allowed-tools:
  - AskUserQuestion
  - Read
  - Write
